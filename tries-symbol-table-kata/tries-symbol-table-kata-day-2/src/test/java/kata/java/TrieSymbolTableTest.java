...
public class TrieSymbolTableTest {
    ...
    @Test
    public void itShouldNotContainKey_whenItDidNotPutIn() throws Exception {
        assertThat(table.get("key"), OptionalMatchers.empty());
    }
    
    @Test
    public void itShouldContainKey_whenItWasPutIn() throws Exception {
        table.put("key", 1);
    ...
    @Test
    public void itShouldContainMultipleDifferentValues() throws Exception {
        table.put("key-1", 1);
        table.put("key-2", 2);
        table.put("key-3", 3);
