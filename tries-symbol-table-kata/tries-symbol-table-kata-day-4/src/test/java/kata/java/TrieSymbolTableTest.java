...
public class TrieSymbolTableTest {
    ...
    @Test
    public void itShouldNotContain_whenValueIsNotPutIn() throws Exception {
        assertThat(table.get("key"), OptionalMatchers.empty());
    }

    @Test
    public void itShouldContainValue_whenItWasPutIn() throws Exception {
        table.put("key", 1);
    ...
    @Test
    public void itShouldOverrideExistedValue() throws Exception {
        table.put("key", 1);
        table.put("key", 2);
