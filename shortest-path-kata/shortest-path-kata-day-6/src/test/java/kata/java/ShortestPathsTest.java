...
public class ShortestPathsTest {
    ...
    public void itShouldNotCreateAShortestPaths_whenDigraphDoesNotContainStartVertex() throws Exception {
        ShortestPaths.create(digraph, 1);
    }

    @Test
    public void itShouldHaveTwoEdgeInShortestPath() throws Exception {
        digraph.addEdge(DirectedEdge.create(1, 2, 1.0));
    ...
    @Test
    public void itShouldHaveThreeEdgeInShortestPath() throws Exception {
        digraph.addEdge(DirectedEdge.create(1, 2, 1.0));
        digraph.addEdge(DirectedEdge.create(2, 3, 1.0));
