...
public class ProbeMapTest {
    ...
    @Test
    public void createsMapWithLesserThanDefaultCapacity() throws Exception {
        assertThat(new ProbeMap(10).capacity(), is(16));
    }

    @Test
    public void createsMapWithGreaterThanDefaultCapacity() throws Exception {
    ...
    @Test
    public void putKeyTwice() throws Exception {
        ProbeMap map = new ProbeMap();
    ...
    @Test
    public void getKeyDoesNotExist() throws Exception {
        ProbeMap map = new ProbeMap();
