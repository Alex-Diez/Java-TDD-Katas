...
public class ProbeMapTest {
    ...
    @Test
    public void putTheSameKeyTwice() throws Exception {
        ProbeMap map = new ProbeMap();
    ...
    public void mapKeys() throws Exception {
        ...
        IntStream.range(0, 10).forEach(key -> map.put(key, key + 20));
    ...
    public void mapValues() throws Exception {
        ...
        IntStream.range(0, 10).forEach(value -> map.put(value, value));

        assertThat(map.values(), containsInAnyOrder(IntStream.range(0, 10).boxed().toArray()));
    }
    ...
    @Test
    public void putCKeysWithCollisionsMoreThanCapacity() throws Exception {
        ProbeMap map = new ProbeMap();
