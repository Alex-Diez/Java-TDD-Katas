...
public class ProbeMapTest {
    ...
    @Test
    public void createMapWithDefaultCapacity() throws Exception {
        assertThat(new ProbeMap().capacity(), is(16));
    }

    @Test
    public void createMapWithCapacityLesserThanDefault() throws Exception {
        assertThat(new ProbeMap(10).capacity(), is(16));
    }

    @Test
    public void createMapWithCapacityGreaterThanDefault() throws Exception {
    ...
    @Test
    public void putTheSameKeyWithDifferentValues() throws Exception {
        ProbeMap map = new ProbeMap();
    ...
    @Test
    public void createMapWithDefaultMissedValue() throws Exception {
        assertThat(new ProbeMap().missedValue(), is(Integer.MIN_VALUE));
    }

    @Test
    public void createMapWithSpecifiedMissedValue() throws Exception {
    ...
    @Test
    public void putMoreKeysThanCapacity() throws Exception {
        ProbeMap map = new ProbeMap();

        IntStream.range(0, 20).forEach(item -> map.put(item, item + 20));
    ...
    public void putKeysWithCollisionMoreThanCapacity() throws Exception {
        ...
        IntStream.iterate(0, item -> item + 16).limit(20).forEach(item -> map.put(item, item + 20));
