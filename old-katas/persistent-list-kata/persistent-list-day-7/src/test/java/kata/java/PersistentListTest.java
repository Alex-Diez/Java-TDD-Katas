...
public class PersistentListTest {
    ...
    @Test
    public void tailOfNonemptyListIsTheAllItemsExceptTheFirstOne() throws Exception {
    ...
    @Test
    public void emptyListIsReversedIntoItself() throws Exception {
        assertThat(empty.reverse().toString(), is("[]"));
    }
    
    @Test
    public void singleListIsReversedIntoItself() throws Exception {
