...
public class PersistentListTest {
    ...
    @Test
    public void headOfNonemptyListIsSomeOfTheFirstItem() throws Exception {
        PersistentList nonempty = PersistentList.empty().prepend(10).prepend(20).prepend(30);
    ...
    @Test
    public void tailOfNonemptyListIsTheAllItemsExceptTheFirst() throws Exception {
    ...
    public void singleListReversesIntoItself() throws Exception {
        PersistentList single = empty.prepend(10);
