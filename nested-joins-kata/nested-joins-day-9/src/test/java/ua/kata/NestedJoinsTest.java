...
class NestedJoinsTest {
  ...
  @Test
  void resultStreamHasValuesOnRight_forCorrespondingKeys_whenJoinLeftTwoNonemptyStreams() throws Exception {
    nestedJoins.leftJoin(
        Flux.create(
            emitter -> emitter
                .next(new ImmutablePair<>(1, "l1"))
  ...
  @Test
  void resultStreamsHasNullsOnLeft_whenJoinRightEmptyAndNonemptyStreams() throws Exception {
  ...
  @Test
  void resultStreamsHasValuesOnLeft_forCorrespondingKeys_whenJoinRightTwoNonemptyStreams() throws Exception {
    nestedJoins.rightJoin(
        Flux.create(
            emitter -> emitter
                .next(new ImmutablePair<>(1, "l1"))
