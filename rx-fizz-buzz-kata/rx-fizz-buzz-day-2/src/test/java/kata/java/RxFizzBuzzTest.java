...
class RxFizzBuzzTest {
  ...
  @Test
  void singleFizzBuzz_whenGiven_dividedByThreeAndFive() throws Exception {
    assertThat(fizzBuzz.fizzBuzz(3 * 5), is(singletonList("FizzBuzz")));
  }

  @Test
  void singleStringifierNumber_whenGiven_neitherDividedByThree_norFive() throws Exception {
