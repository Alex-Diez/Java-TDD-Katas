...
public class ResizableDequeTest {
    ...
    @Test
    public void createDequeWithLesserThanDefaultCapacity() throws Exception {
    ...
    @Test
    public void shrinkCapacityWhenRemoveBackThreeQuarterOfItems() throws Exception {
    ...
    @Test
    public void shrinkCapacityWhenRemoveFrontThreeQuarterOfItems() throws Exception {
        ResizableDeque deque = new ResizableDeque(64);
    ...
    private void addMany(IntConsumer consumer, int from, int till) {
        for (int item = from; item < till; item++) {
