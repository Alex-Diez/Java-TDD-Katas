...
class MinTriangleSumTest {
  ...
  @Test
  void treeLevelsTriangle() {
    assertThat(new MinTriangleSum(List.of(List.of(1), List.of(2, 3), List.of(4, 5, 6))).compute()).isEqualTo(7);
  }

  @Test
  void treeLevelsTriangle_withNegativeValue() {
    assertThat(new MinTriangleSum(List.of(List.of(1), List.of(2, -3), List.of(4, 5, 6))).compute()).isEqualTo(3);
  }
